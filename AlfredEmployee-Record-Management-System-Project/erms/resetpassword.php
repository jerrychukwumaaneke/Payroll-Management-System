...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con,"update empprofile set password='$password'  where  email='$email' && EmpContactNo='$empid' ");
   if($query)
   {
...
<head>
  ...
  <title>DU|Payroll Managment System Employee Login| Reset Password</title>
