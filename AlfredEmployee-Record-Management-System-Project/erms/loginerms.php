...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"select ID from empprofile where  email='$Email' && password='$Password' ");
...
<body style="background-color:black;">
  ...
  <div class="container">
    <h3 align="center" style="color: white; padding-top: 2%">DU|Payroll Management System</h3>
    ...
    echo $msg;
                  ...
                  <form class="user" method="post" action="">
                    ...
                    <p> <input type="submit" style="background-color: black;" class="btn btn-primary btn-user btn-block" name="login" value="login"></p>
